...
![alt text](\assets\img\Hedgehog-image.png)
...
![alt text](\assets\img\Hedgehog-image-1.png)
...
![alt text](\assets\img\Hedgehog-image-2.png)
...
![alt text](\assets\img\Hedgehog-image-3.png)
...
![alt text](\assets\img\Hedgehog-image-4.png)
...
![alt text](\assets\img\Hedgehog-image-5.png)

Estamos dentro de la maquina victima siendo el usuario **tails**

![alt text](\assets\img\Hedgehog-image-6.png)
...
![alt text](\assets\img\Hedgehog-image-7.png)
...
![alt text](\assets\img\Hedgehog-image-8.png)
...
![alt text](\assets\img\Hedgehog-image-9.png)
